...
| Gap | Why it matters |
|---|---|
| No endpoint-level test suite | The sibling contract-review system has one; here the endpoints are covered by hand and by the live probe |
