    ...
    <section className="panel p-7 space-y-5">
      ...
      <div className="flex flex-wrap gap-5 items-start">
        <label className="text-[13px]">
          <div className="text-[13px] uppercase tracking-wide text-[var(--ink-soft)] mb-1">
            company policy
          </div>
      ...
      <div className="pt-4 border-t border-[var(--line)]">
        <h3 className="text-[13px] font-semibold">Controls at this tier</h3>
        <p className="text-[13px] text-[var(--ink-soft)] mt-1 max-w-[62ch]">
        ...
        <div className="mt-3">
          ...
          {controls.map((c) => (
            ...
            >
              ...
              <span className="text-[13px] font-mono w-[76px] text-[var(--ink-soft)]">{c.id}</span>
              ...
              {c.attested?.note && (
                <span className="w-full text-[13px] text-[var(--ink-soft)]">
